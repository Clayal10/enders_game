...
This repo also contains source code for a [LURK Client](https://isoptera.lcsc.edu:5068) which allows you to play _Enders's Game_ in your browser. The _Ender's Game_ server is running on port *5069* on the default host _isoptera.lcsc.edu_.
